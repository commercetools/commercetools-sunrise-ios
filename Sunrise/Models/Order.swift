        ...
        return SignalProducer { observer, disposable in
            ...
            Customer.profile { result in
                if let profile = result.model, result.isSuccess {
                    ...
                    let cartDraft = CartDraft(currency: AppDelegate.currentCurrency ?? BaseViewModel.currencyCodeForCurrentLocale, customerEmail: profile.email, lineItems: [lineItemDraft], shippingAddress: shippingAddress, billingAddress: billingAddress, custom: customType)
